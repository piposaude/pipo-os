...
| `COMPANY_SERVICE_INTERNAL_URL` | `http://company-service.default:4000`                               | URL do listener **interno** do company-service, de onde `GET /api/companies` lê nome e CNPJ das empresas                                                                                   |
