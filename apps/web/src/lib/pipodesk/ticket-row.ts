...
export function toTicketRow(ticket: Ticket): TicketRow {
  ...
  const { beneficiaryName, taxId, companyName } = snapshotHeadline(ticket.enrollmentSnapshot)
