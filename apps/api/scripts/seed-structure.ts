import { applyPlan, SeedRunError, type SeedClient, type Tally } from '../src/seed/apply.js'
...
async function main(): Promise<void> {
  ...
  const print = (created: Tally, interrupted?: boolean): void => {
